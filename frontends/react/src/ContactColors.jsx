...
export default function ContactColors() {
  ...
  for (let index = 1; index <= 6; index++) {
    ...
    cards.push(<section key={key} className="contact-box" aria-label={`Contact ${index}`}>
      <h2 style={{backgroundColor: contact.color || '#29384d'}}>Contact {index}</h2>
      <div className="input-fields">
        ...
        <label>Title background<input name="color" type="color" value={contact.color || '#29384d'} onChange={commit} /></label>
      </div>
    </section>)
  }
